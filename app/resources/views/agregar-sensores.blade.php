                    ...
                    <form action="/addSensor" method="POST">
                      @csrf
                          <div class="card-body text-center">
                              <h2 class="card-title text-primary">Agregar Sensores</h2>
                          </div>
                          <div class="form-group">
                              <label for="inputUsername">Nombre del sensor</label>
                              <input name="name" type="text" class="form-control" placeholder="Nombre Del Sensor " id="inputUsername">
                          </div>
                  
                        <div class="form-group">
                          <label for="inputUsername">Ubicacion</label>
                          <input name="location"  type="text" class="form-control" placeholder="Ubicacion Del sensor " id="inputUsername">
                      </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                          <div>
                            <label for="inputEstado">Temperatura</label>
                          </div>
                            <label for="sensorTempMax">Máxima (°C):</label>
                            <input name="maxTemp" type="number" id="sensorTempMax" min="1.0" max="30.0" step="0.1" pattern="^\d{2}(\.\d{1})?$" required>
                            <label for="sensorTempMin">Mínima (°C):</label>
                            <input name="minTemp" type="number" id="sensorTempMin" min="1.0" max="30.0" step="0.1" pattern="^\d{2}(\.\d{1})?$" required>
                          </div>

                        <div class="form-group">
                          <div>
                          <label for="inputEstado">Humedad</label>
                          </div>
                          <label for="sensorTempMax">Máxima (%):</label>
                          <input name="maxHum" type="number" id="sensorTempMax" min="40.0" max="60.0" step="0.1" pattern="^\d{2}(\.\d{1})?$" required>
                          <label for="sensorTempMin">Mínima (%):</label>
                          <input name="minHum" type="number" id="sensorTempMin" min="40.0" max="60.0" step="0.1" pattern="^\d{2}(\.\d{1})?$" required>
                        </div>
                      </div>
